  ...
  useEffect(() => {
    ...
    const timer = setTimeout(async () => {
      ...
      try {
        ...
        const msg = exists ? 'Already filled — this barcode is registered. Scan a different code or find the existing item.' : '';
        setBarcodeError(msg);
        if (exists) {
          notifyError('Already filled — this barcode is registered. Scan a different code or find the existing item.');
        }
      } catch {
        setBarcodeError('');
      } finally {
        ...
        <form onSubmit={handleSubmit} className="space-y-4 min-w-0">
          ...
          <div>
            <label className="flex items-center gap-1.5 text-sm font-medium text-slate-700 mb-1">
              ...
              <InfoTooltip text="Physical scanner: focus here and scan. Camera: click Scan. Or type manually. System checks if exists; new items get unique suffix." />
            </label>
              ...
              <div className="sm:flex-1 min-w-0">
                <input
                  ...
                  onKeyDown={(e) => {
                    if (e.key === 'Enter') {
                      e.preventDefault();
                      const currentValue = e.target.value ?? form.barcode;
                  ...
                  placeholder="Focus here, then scan with physical scanner — or click Scan for camera"
